...
clip_scores = read_csv(here::here('/home/yinzi/workspace/clip-alignment/all_namings_with_cor.csv'))
```

```{R}
# demo <- read_csv(here::here('data/xs-face/demographics_updated.csv')) %>%
demo <- read_csv(here::here('/home/yinzi/workspace/clip-alignment/data/xs-face/demographics_updated.csv')) %>%
...
best_examples <- clip_scores_clean %>%
  ...
  mutate(image_name = paste0(here::here('/data/yinzi/xs_face/frames_full_working',child_id, name, time),'.jpg')) %>%

...
def process_files_in_folder(folder_path, target_string, value, csv_writer, output_csv, was_empty):
    ...
    for filename in os.listdir(folder_path):
        if target_string in filename:
            ...
            entry = [value['utterance'], filename]
            if was_empty:
...
def extract_frames(input_video, output_folder, json_file, output_csv):
    ...
    with open(output_csv, 'a', newline='') as csv_file:
        ...
        for key, value in data.items():
            ...
            process_files_in_folder(output_folder, name_wo_numbering, value, csv_writer, output_csv, was_empty)
